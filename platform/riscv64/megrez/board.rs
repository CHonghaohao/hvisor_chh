...
#[allow(unused)]
pub const BOARD_NAME: &str = "qemu-plic";
...
pub const ROOT_ZONE_MEMORY_REGIONS: [HvConfigMemoryRegion; 3] = [
    ...
    HvConfigMemoryRegion {
        mem_type: MEM_TYPE_IO,
        physical_start: 0x24000000,
        virtual_start: 0x24000000,
        size: 0x10000,
    }, // serial
];
...
pub const HW_IRQS: [u32; 7] = [1, 2, 3, 4, 5, 8, 100];

// irqs belong to the root zone.
pub const ROOT_ZONE_IRQS: [u32; 7] = [1, 2, 3, 4, 5, 8, 100];
